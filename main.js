...
const reponse = prompt(`${questions[i].question}\n\nA: ${questions[i].reponseA}\nB: ${questions[i].reponseB}`);
if (reponse.toUpperCase() === "A") {
    score++;
}
}

console.log(`Vous avez obtenu un score de ${score} sur ${questions.length}.`);
